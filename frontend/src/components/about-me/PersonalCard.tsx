export const PersonalCard: React.FC = () => {
  return (
    <div className="flex w-full md:w-4/6 h-2/6 sm:h-1/4  justify-center place-items-center bg-white rounded-xl overflow-hidden shadow-xl p-4 gap-4 lg:gap-8 flex-col lg:flex-row max-w-4xl">
